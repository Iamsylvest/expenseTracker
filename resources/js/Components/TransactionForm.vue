    ...
    <div class="w-full p-6 bg-white rounded-lg shadow-md max-w-7xl">
      ...
      <form @submit.prevent="submitForm">
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-3">
          ...
          <div class="mb-4">
            <label class="block mb-1 font-medium text-gray-700">Income</label>
            <input
              v-model="form.income"
              type="text"
        ...
        <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
          ...
          <div class="mb-4">
            ...
            <select id="unit" v-model="unit" class="w-full p-2 border rounded">
        ...
        <button
          type="button"
          class="px-4 py-2 text-white bg-red-600 border rounded hover:bg-red-700"
        >
          delete
        </button>
