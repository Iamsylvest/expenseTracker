...
<template>
  ...
  <div class="absolute w-full p-3 rounded-b-lg shadow-sm bg-custom-darkblue">
    ...
    >
      ...
      <div>
        <div class="p-4 space-y-6 text-center">
          <!-- 🧠 Headline -->
          <p class="text-2xl font-bold text-gray-800 sm:text-5xl">
            "Welcome! Ready to track your expenses? You're in the right place."
          </p>
          ...
          <div v-if="canLogin" class="mt-8">
            ...
            <Link
              ...
              class="inline-block text-lg font-semibold text-blue-700 hover:underline focus:outline focus:outline-2 focus:outline-blue-400"
            >
              Go to Dashboard
            </Link>
